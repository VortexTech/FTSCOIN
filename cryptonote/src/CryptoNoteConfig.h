...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x1e0468; /* fts address prefix */
...
const uint64_t MINIMUM_FEE = UINT64_C(10); /* 0.000010 FTS */
const uint64_t MINIMUM_FEE_V1 = UINT64_C(100); /* 0.000100 FTS */
const uint64_t MINIMUM_FEE_V2 = UINT64_C(1000); /* 0.001000 FTS */
const uint64_t MINIMUM_FEE_BANKING = UINT64_C(1000); /* 0.001000 FTS */
const uint64_t DEFAULT_DUST_THRESHOLD = UINT64_C(10); /* 0.000010 FTS */  
...
const uint64_t UPGRADE_HEIGHT_V7 = 195765; /* Cryptoight FTSCoin */
...
const uint64_t REWARD_INCREASE_INTERVAL = (UINT64_C(21900)); // aprox. 1 month (+ 0.25 FTS increment per month)

const char     CRYPTONOTE_NAME[] = "FTSCoin";
const char     GENESIS_COINBASE_TX_HEX[] = "010a01ff000180d0f29ce14802f917ad80b58f237e78a59caf24d3aba747a57221b8bc175499b785247856f5b62101a4985f50aba9a76022e60628adb6752ef4df5dcefb71bae0ec18639333f1e340";
const uint32_t GENESIS_NONCE = 10000;
const uint64_t GENESIS_TIMESTAMP = 1580988736;
...
const uint8_t  BLOCK_MAJOR_VERSION_7 = 7; /* Cryptonight FTSCoin */
...
const std::initializer_list<const char*> SEED_NODES  = {
	"node1.ftscoin.xyz:42648",
	"node2.ftscoin.xyz:42648",
	"node3.ftscoin.xyz:42648",
	"node4.ftscoin.xyz:42648",
	"node5.ftscoin.xyz:42648",
	"node6.ftscoin.xyz:42648"
};
